...
export const Image = ({intersection,opacity} : Props) => {
  ...
  return (
    <div className={`imageContainer mt-[50px] flex flex-col overflow-hidden relative justify-center gap-1 items-center p-3 `} >
      ...
      <a href='https://www.linkedin.com/in/liran-ramekar-398163217/' className={`icon ${intersection > 90 ? "opacity-1 -translate-y-0" : "opacity-0 -translate-y-5"} w-[30px] h-[0px] md:w-[30px] md:h-[30px] lg:w-[30px] lg:h-[30px]  rounded-full duration-500 text-cyan-500 scale-75 flex bg-[rgba(6,182,212,.18)] gap-2 cursor-pointer justify-center items-center  hover:-translate-y-2 hover:scale-100`}><FaLinkedinIn size={20}/></a>
      <a href='https://www.instagram.com/liranimmanuel/' className={`icon ${intersection > 90 ? "opacity-1 translate-y-0" : "opacity-0 -translate-y-5"} w-[30px] h-[0px] md:w-[30px] md:h-[30px] lg:w-[30px] lg:h-[30px]  rounded-full duration-500 text-cyan-500 scale-90 flex bg-[rgba(6,182,212,.18)] gap-2 cursor-pointer justify-center items-center  hover:-translate-y-2 hover:scale-100`}><FaInstagram size={30}/></a>
      <div className='image w-[100px] h-[100px] rounded-full duration-500 bg-cyan-500 flex gap-2 justify-center items-center'></div>
      <a href='https://www.facebook.com/liran.immanuel' className={`icon ${intersection > 90 ? "opacity-1 translate-y-0" : "opacity-0 -translate-y-5"} w-[30px] h-[0px] md:w-[30px] md:h-[30px] lg:w-[30px] lg:h-[30px]  rounded-full duration-500 text-cyan-500 scale-90 flex bg-[rgba(6,182,212,.18)] gap-2 cursor-pointer justify-center items-center  hover:-translate-y-2 hover:scale-100`}><FaFacebookF size={30}/></a>
      <a href='https://github.com/lyran10' className={`icon ${intersection > 90 ? "opacity-1 -translate-y-0" : "opacity-0 -translate-y-5"} w-[30px] h-[0px] md:w-[30px] md:h-[30px] lg:w-[30px] lg:h-[30px] rounded-full duration-500 text-cyan-500 scale-75 bg-[rgba(6,182,212,.18)] flex gap-2 cursor-pointer justify-center items-center  hover:-translate-y-2 hover:scale-100`}><FaGithub size={20}/></a>
      </div>
