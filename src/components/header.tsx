...
export const Header = ({showContent,showAfter,beforeContent,content,beforeNum,num} : Props) => {
  return (
    <div className={`relative flex text-[#f5f5f5] font-bold gap-3 before:duration-500 after:content-'' after:absolute  after:h-[1px] after:top-[50%] after:right-0 after:bg-[#526D82]  ${showContent ? "after:w-[15%] md:after:w-[50%] lg:after:w-[60%] before:opacity-1" : "before:w-[0%] before:opacity-0"}`}>
